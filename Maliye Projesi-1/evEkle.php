...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["durum"]))) {
        array_push($error, "Evin durumunu belirtiniz");
    } else {
    ...
    if (count($error) == 0) {
        ...
        $flag = $evcont->evEkle($kisi_id,$il_id, $ilce_id, $adres,$durum,$m2);
        if ($flag) {
                ...
                <div class="card-body">
                    ...
                    <div class="container" style=";margin-bottom: 55px; width:40% ; height: 100%">
                        <form action="evEkle.php" method="POST">
                            ...
                            <div class="form-group">
                                <label for="">Durum Giriniz</label>
                                <input type="text" class="form-control" name="durum" id="text"
                                       placeholder="Satılık ya da Kiralık..">
                            </div>
                            <div class="form-group">
                                <label for="">İl</label>
                            ...
                            <div class="form-group">
                                <label for="">M²</label>
                                <input type="text" class="form-control" name="m2" id="text"
                                       placeholder="Metrekaresini giriniz..">
                            </div>
                            <div align="right">
